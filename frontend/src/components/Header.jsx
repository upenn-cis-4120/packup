...
const Header = () => {
  return (
    <header className={styles.header}>
      <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/b2da728e-2fc6-4486-9e80-4f0649458192?placeholderIfAbsent=true&apiKey=3a931a869e0e4b4bb92008bc01989510" alt="Logo" className={styles.logo} />
